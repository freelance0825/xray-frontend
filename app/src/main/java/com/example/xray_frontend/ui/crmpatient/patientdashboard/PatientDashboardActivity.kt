...
import com.example.xray_frontend.ui.crmpatient.patientdashboard.adapters.PatientAdapter
import com.example.xray_frontend.ui.crmpatient.patientdashboard.screens.EditPatientFragment
    ...
    private fun setListeners() {
        binding.apply {
            ...
            settingsIcon.setOnClickListener {
                startActivity(Intent(this@PatientDashboardActivity, SettingsActivity::class.java))
