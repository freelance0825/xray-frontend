...
import com.example.xray_frontend.ui.crmpatient.patientarchive.adapters.PatientArchiveAdapter
import com.example.xray_frontend.ui.settings.SettingsActivity

class PatientArchiveActivity : BaseActivity() {
    ...
    private fun setListeners() {
        ...
        binding.settingsIcon.setOnClickListener {
            startActivity(Intent(this@PatientArchiveActivity, SettingsActivity::class.java))
